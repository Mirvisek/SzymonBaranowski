            ...
            <div className="max-w-4xl mx-auto px-4 text-center">
                ...
                <div className="relative">
                    ...
                    <div className="flex justify-center mt-8 gap-4">
                        <button onClick={prev} className="p-2 rounded-full bg-gray-200 hover:bg-primary hover:text-white transition-colors" aria-label="Poprzednia opinia">
                            <ChevronLeft />
                        </button>
                        <button onClick={next} className="p-2 rounded-full bg-gray-200 hover:bg-primary hover:text-white transition-colors" aria-label="Następna opinia">
                            <ChevronRight />
                        </button>
                    </div>
                </div>
