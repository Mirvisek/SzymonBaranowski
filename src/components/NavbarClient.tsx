...
export default function NavbarClient({ brandName, logoUrl }: { brandName: string; logoUrl: string }) {
                    ...
                    <div className="flex-shrink-0">
                        <Link href="/" className="flex items-center">
                            {logoUrl ? (
                                ...
                                <span className="text-2xl font-bold text-dark font-sans tracking-tight">
